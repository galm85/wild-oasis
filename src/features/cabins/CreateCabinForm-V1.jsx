  ...
  return (
    <Form onSubmit={handleSubmit(onSubmit,onError)}>
      ...
      <FormRow label="Cabin name" error={errors?.name?.message}>
        <Input type="text" id="name" disabled={isCreating} {...register("name",{required:'This field is requierd'})}/>
      </FormRow>
      ...
      <FormRow label="Regular price" error={errors?.regularPrice?.message}>
        <Input type="number" id="regularPrice" disabled={isCreating} {...register("regularPrice",{
          required:'This field is requierd',
          min:{value:1,message:'Price shoud be at least 1'}})}/>
      </FormRow>

      <FormRow label="Discount" error={errors?.discount?.message}>
        <Input type="number" id="discount" disabled={isCreating} defaultValue={0} {...register("discount",{
          required:'This field is requierd',
          validate:(value)=> value <= getValues().regularPrice || 'Disacount should be less the regular price'
          })} />
      </FormRow>

      <FormRow label="Description for website" error={errors?.description?.message}>
        <Textarea type="number" id="description" disabled={isCreating} defaultValue="" {...register("description",{required:'This field is requierd'})} />
      </FormRow>
